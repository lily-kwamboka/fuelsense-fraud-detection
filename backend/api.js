...
// ── ADMIN: PUT /api/admin/stations/:id ────────────────────────────────────
...
// ── ADMIN: DELETE /api/admin/stations/:id ─────────────────────────────────
  ...
  try {
    ...
    const result = await client.query(
      `UPDATE tanks SET
         ...
         fuel_type              = $2,
         capacity_litres        = $3,
         fuel_density_at_15c    = $4,
         low_stock_threshold_pct = $5
...
// ── ADMIN: DELETE /api/admin/tanks/:id ────────────────────────────────────
...
// ── ADMIN: PUT /api/admin/suppliers/:id ──────────────────────────────────
app.put('/api/admin/suppliers/:id', async (req, res) => {
  const { name, contact_name, phone, email, address, is_active } = req.body;
  try {
    const client = await getDb();
    const result = await client.query(
      `UPDATE suppliers SET name=$1, contact_name=$2, phone=$3, email=$4, address=$5, is_active=$6
...
// ── ADMIN: DELETE /api/admin/suppliers/:id ────────────────────────────────
